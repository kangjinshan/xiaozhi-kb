...
- [ ] **Step 2: Run the test under FATFS rename semantics**
...
- [ ] **Step 1: Implement the minimal replacement helper**
...
- [ ] **Step 2: Verify manifest replacement turns green**

Run the Task 1 command. Expected: PASS with the simulated no-overwrite rename.

- [ ] **Step 3: Extend the test for assistant WAV replacement**
...
- [ ] **Step 4: Verify the extended test**
...
- [ ] **Step 1: Write the failing recovery assertion**
...
- [ ] **Step 4: Run FATFS and ordinary store tests**
...
- [ ] **Step 2: Build and flash without NVS erase**
